...
#create the plot4 with sub_metering1
plot(sub_powerData$Global_active_power ~ sub_powerData$datetime, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")

plot(sub_powerData$Voltage ~ sub_powerData$datetime, type = "l", xlab="datetime", ylab = "Voltage")
...
plot(sub_powerData$Global_reactive_power ~ sub_powerData$datetime, type = "l", xlab="datetime",ylab="Global_reactive_power")
